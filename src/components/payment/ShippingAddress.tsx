...
export default function ShippingAddress() {
  return (
    <>
      <CustomCheckBox style="flex right-0 gap-6 mb-6 text-2xl leading-none justify-end">
        기본 배송지 적용
      </CustomCheckBox>
      <div className="flex flex-col gap-4 text-xl font-semibold">
        <div className="flex w-full items-center">
          <div className="w-1/6">받으시는 분</div>
          <ShippingInput
            layout="w-5/6 ml-6"
        ...
        <div className="flex items-center">
          <div className="w-1/6">받으시는 분 연락처</div>
          <ShippingInput
            layout="w-5/6 ml-6"
        ...
        <div className="flex items-center">
          <div className="w-1/6">배송 메세지</div>
          <ShippingInput
            layout="w-5/6 ml-6"
